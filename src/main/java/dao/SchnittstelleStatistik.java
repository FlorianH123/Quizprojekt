...
public class SchnittstelleStatistik {
     ...
     */
    public List<Statistik> getTopTenOverallWorldWide(String gameMode){
        ResultSet rs;
    ...
    /**
     * Methode um die Top 10 Spiele eines Spielers im jeweiligen Game Mode zurueck zugeben
     * @param id ID des Benutzers
     * @param gameMode Game Mode
     * @return Liste der Spiele des jeweiligen Game Modes
     */
